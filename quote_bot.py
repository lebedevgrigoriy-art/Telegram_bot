...
def generate_quote() -> str:
    ...
    if context:
        prompt = (
            "Вот недавние записи человека из дневника саморефлексии:\n\n"
            f"{context}\n\n"
            "Подбери ОДНУ реальную, проверяемую цитату известного человека (философа, писателя, "
            "учёного, предпринимателя), которая откликается на то, что человек сейчас переживает. "
            "Цитата должна быть подлинной, не выдумывай. "
            "Ответь СТРОГО в формате:\n«Цитата»\n— Автор\n\nБез пояснений, только цитата и автор."
        )
    else:
        prompt = (
